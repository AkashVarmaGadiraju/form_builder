									...
									>
										...
										<div className="py-[25px] px-[30px] pl-2 gap-[13px] flex flex-col">
											...
											<div className="text-gray-500 font-roboto text-xs font-normal leading-22">
												Drag and Drop a field type to get started. Various Design Elements and Button Elements can also be
										...
										<div className="w-full h-[70%] overflow-y-scroll flex flex-col gap-[13px] z-50">
