...
const FieldList: FunctionComponent = () => {
	...
	let tableData = [];
	return (
		<main className="w-[90%] h-[100%] flex flex-col justify-start box-border max-w-full mx-auto pt-16">
			<section className="self-stretch flex flex-col items-start justify-start gap-[21px] max-w-full mq825:gap-[21px] h-[95%]">
				<div className="self-stretch flex flex-col items-start justify-start gap-[17px] max-w-full text-left text-11xl text-darkslateblue font-roboto">
					<h1 className="m-0 relative font-semibold font-merriweather-sans inline-block text-2xl">Field List</h1>
					<form className="m-0 self-stretch h-[55px] flex flex-row items-start justify-start gap-[9px] max-w-full">
						...
						<div className="flex flex-row justify-end gap-[9px]">
							...
							<div className="h-full w-[162.4px] flex flex-col items-start justify-start px-0 pb-0 box-border">
								<CreateButton title={"Create Field"} sheetContent={<CreateFieldModal users={fields} setUsers={setUsers} />} />
							</div>
						</div>
					</form>
				</div>
				<Dialog>
					{filteredItems.length <= 0 ? (
						<div className="self-stretch rounded-3xs bg-gray-200 box-border flex flex-col items-center justify-center gap-[16px] max-w-full text-center text-base text-darkslateblue font-noto-sans border-[1px] border-dashed border-seagreen h-[100%]">
							...
							<div className="w-[352px] flex flex-col gap-3 max-w-full">
