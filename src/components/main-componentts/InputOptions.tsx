...
const InputOptions: React.FC<{
  handleChanges: (e: any, key: string, isCategory?: boolean) => void;
      ...
      {values.type === "string" && (
        <div className="self-stretch flex flex-row flex-wrap items-start justify-between relative pb-10 gap-[12px]">
          <div className="w-full flex flex-col items-start justify-start py-0 pl-0 box-border gap-[8px]">
            <div className="text-darkslateblue font-noto-sans text-sm font-bold leading-5">
              Length
            </div>
            <Input
              type="number"
              placeholder="20"
              className="w-full flex items-center justify-between rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm hover:border-gray-400 focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:hover:border-gray-500  "
              onChange={(e) => {
          ...
          <div className="w-[45%] flex flex-col items-start justify-start py-0 pl-0 box-border gap-[8px] mt-3">
            <div className="flex items-center space-x-2">
              ...
              <label
                ...
                className="text-darkslateblue font-noto-sans text-sm"
              >
                Is Required?
              </label>
            </div>
        ...
        <div className="self-stretch flex flex-row flex-wrap items-start justify-between relative pb-10 gap-[12px]">
          ...
          <div className="w-[46%] flex flex-col items-start justify-start py-0 pl-0 box-border gap-[8px] mt-3">
            <div className="flex items-center space-x-2">
              ...
              <label
                htmlFor="required-check"
                className="text-darkslateblue font-noto-sans text-[13px]"
              >
                Is Required?
              </label>
            </div>
